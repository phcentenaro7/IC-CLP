...
#     layer = add_layer!(db, container_id, item_id, z, layer_depth)
#     add_space!(db, layer[:id], [container[:width], container[:height], layer_depth], [0, 0, z], :primary)
#     db.containers[container_id, :remaining_depth] -= layer_depth
#     return layer
# end
...
#     dims = [minimum(row_dims) for row_dims in eachrow(R[:,[:dim1, :dim2, :dim3]])]
